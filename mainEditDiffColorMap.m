...
for i = 1:size(imagesStructBlue,2)-1
    ...
    image3 = removeStragglersGray(findLargestSectionGray(zeroInRange(imagesStructBlue(i).image,1,8)));
    image4 = removeStragglersGray(findLargestSectionGray(zeroInRange(imagesStructGreen(i+1).image,1,8)));
