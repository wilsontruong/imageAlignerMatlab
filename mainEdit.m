...
%         if yOffset > 0
%             image1(height-yOffset:height, :) = 0;
%         elseif yOffset < 0
%             image1(1:abs(yOffset), :) = 0;
%         end
        if xOffset > 0
    ...
    if i == 1
        ...
        %  Shift the gray image and fill the shifted area with 255
%         if yOffset > 0
%             image3(height-yOffset:height, :) = 0;
%         elseif yOffset < 0
%             image3(1:abs(yOffset), :) = 0;
%         end
        if xOffset > 0
            image3(:, end-xOffset+1:end) = 0;
        elseif xOffset < 0
            image3(:, 1:abs(xOffset)) = 0;
        end
    end
